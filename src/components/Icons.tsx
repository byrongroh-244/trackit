...
// Spread into every svg to mark icons as decorative for screen readers
const a11y = { 'aria-hidden': true as const, focusable: 'false' as const } as
  React.SVGProps<SVGSVGElement>;

// ── Navigation & UI chrome ────────────────────────────────────────────────────

export const IconCheck = ({ size = 20, color, strokeWidth = 2 }: IconProps) => (
  <svg viewBox="0 0 24 24" aria-hidden="true" focusable="false" style={{ ...base(size, strokeWidth), stroke: color ?? 'currentColor' }}>
